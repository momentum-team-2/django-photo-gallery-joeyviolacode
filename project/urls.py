...
urlpatterns = [
    ...
    path('photo/<int:pk>/<int:photo_index>', core_views.ShowPhoto.as_view(), name="show_photo"),
    ...
    path('user/<int:user_pk>/photo/<int:photo_index>', core_views.ShowUserPhoto.as_view(), name="show_user_photo"),
    path('user/<int:user_pk>/photo', core_views.ShowUserPhoto.as_view(), name="show_user_photo"),
